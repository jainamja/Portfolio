...
function App() {
  ...
  return (
    <div>
      ...
      <nav className={`px-6 md:px-10 py-4 md:py-6 bg-slate-900 sticky top-0 z-50 shadow-lg transition-transform duration-300 ${showNavbar ? 'translate-y-0' : '-translate-y-full'}`}>
        ...
        {isMobileMenuOpen && (
          <motion.ul 
            ...
            className="md:hidden flex flex-wrap justify-center gap-6 mt-6 text-lg pb-2"
          >
            <li><a href="#about" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-cyan-400 transition">About</a></li>
            <li><a href="#skills" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-cyan-400 transition">Skills</a></li>
            <li><a href="#projects" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-cyan-400 transition">Projects</a></li>
            <li><a href="#contact" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-cyan-400 transition">Contact</a></li>
          </motion.ul>
        )}
      </nav>
  ...
  <div className="p-6">
    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mt-4">
          <span className="bg-cyan-500/20 text-cyan-300 px-3 py-1 rounded-full text-sm">React</span>
          <span className="bg-cyan-500/20 text-cyan-300 px-3 py-1 rounded-full text-sm">Node.js</span>
          <span className="bg-cyan-500/20 text-cyan-300 px-3 py-1 rounded-full text-sm">Express</span>
          <span className="bg-cyan-500/20 text-cyan-300 px-3 py-1 rounded-full text-sm">MongoDB</span>
          <span className="bg-cyan-500/20 text-cyan-300 px-3 py-1 rounded-full text-sm">JWT</span>
        </div>
